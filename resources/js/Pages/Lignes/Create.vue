                ...
                <form class="creation-form" @submit.prevent="submit">
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            <label class="form-label required">Nom de la ligne</label>
                            <input
                                type="text"
                                class="form-input"
                                v-model="form.nom"
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-grid">
                            <!-- Gare de départ -->
                            <div class="form-group">
                                <label class="form-label required">Gare de départ</label>
                                <select
                                    class="form-select"
                                ...
                                <div v-if="form.errors.gare_depart_id" class="form-error">
                            ...
                            <!-- Gare d'arrivée -->
                            <div class="form-group">
                                <label class="form-label required">Gare d'arrivée</label>
                                <select
                                    class="form-select"
                                ...
                                <div v-if="form.errors.gare_arrivee_id" class="form-error">
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            <label class="form-label required">Distance totale</label>
                            ...
                            <div v-if="form.errors.distance_totale" class="form-error">
                    ...
                    <div class="form-actions">
                        ...
                        >
                            <span
                                ...
                                class="spinner"
                            ></span>
                            {{ form.processing ? 'Enregistrement en cours...' : 'Enregistrer la ligne' }}
                        </button>
                    </div>
                </form>
            </div>
