...
const props = defineProps({
    distances: Object, // paginated data
...
const editDistance = (id) => {
    router.visit(route("distance.edit", id));
};

// 🗑️ Suppression avec confirmation
const deleteDistances = (id) => {
    Swal.fire({
        title: "Êtes-vous sûr ?",
        ...
        if (result.isConfirmed) {
            router.delete(route("distance.destroy", id), {
                onSuccess: () => {
                    Swal.fire(
                        "Supprimé !",
        ...
        <div class="row page-title-header">
            <div class="col-12">
                <div class="page-header">
                    <h4 class="page-title">Gestion des Distances de Gares</h4>
                    <div
                    ...
                    <div class="card-body">
                       ...
                       <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <tr
                                        v-for="(distance, index) in distances.data"
                                        :key="distance.id"
                                    >
                                        <td>{{ index + 1 }}</td>
                                        ...
                                        <td>
                                            ...
                                            <button
                                                @click="editDistance(distance.id)"
                                            ...
                                            <button
                                                @click="deleteDistances(distance.id)"
                                    ...
                                    <tr v-if="distances.data.length === 0">
                                        <td
                                            colspan="8"
                                            class="text-center py-4 text-muted"
                                        >
                                            Aucune distance de gare trouvée
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
