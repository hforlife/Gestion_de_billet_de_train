...
const form = useForm({
    train_id: props.wagons.train_id || "",
    nom: props.wagons.nom || "",
    nombre_places: Number(props.wagons.nombre_places || 0),
});

const submit = () => {
    form.put(route("wagon.update", props.wagons.id), {
        onSuccess: () => {
        ...
        <div class="row page-title-header">
            <div class="col-12">
                <div class="page-header">
                    <h4 class="page-title">Modifier le wagon</h4>
                </div>
            </div>
        </div>
