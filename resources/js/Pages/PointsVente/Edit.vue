...
const form = useForm({
    gare_id: props.pointVente?.gare_id || '',
    type: props.pointVente?.type || '',
    actif: props.pointVente?.actif || false,
});

const submit = () => {
    form.put(route('points-vente.update', props.pointVente.id), {
        onSuccess: () => {
            Swal.fire("Succès", "Point de vente modifié avec succès", "success");
        },
        onError: () => {
        ...
        <div class="form-header">
            <div class="header-content">
                <div class="header-title-wrapper">
                    <h1 class="page-title">Modifier Point de Vente</h1>
                    <Link
                ...
                <div class="breadcrumb-wrapper">
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Mdifier Point de Vente</li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <div class="form-actions">
                        ...
                        >
                            <span
                                ...
                                class="spinner"
                            ></span>
                            {{ form.processing ? 'Modification en cours...' : 'Modifier le point de vente' }}
                        </button>
                    </div>
                </form>
            </div>
