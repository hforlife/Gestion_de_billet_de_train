                ...
                <div class="filter-group search-group">
                    ...
                    <div class="search-box">
                        <input
                            ...
                            class="search-input"
                            aria-label="Rechercher des points de vente"
                            @keyup.enter="
                                router.get(route('points-vente.index'), filters)
                            "
                        />
                        <button
                            class="search-btn"
            ...
            <div class="sales-container">
                <div class="sales-card">
                    <div class="table-header">
                        <h3 class="table-title">Liste des points de ventes</h3>
                        <Link
                            :href="route('points-vente.create')"
                            class="btn-create-sm"
                    ...
                    <div class="table-footer">
                        <div class="pagination-info">
                            <p class="text-muted">
                                ...
                                {{ pointsVente.to }} sur
                                {{ pointsVente.total }} Points de Vente
                            </p>
                        </div>
