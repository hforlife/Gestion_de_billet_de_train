        ...
        <div class="form-header">
            <div class="header-content">
                <div class="header-title-wrapper">
                    <h1 class="page-title">Modifier Info Colis</h1>
                ...
                <div class="creation-form">
                    ...
                    <form @submit.prevent="submit">
                        <div class="form-grid">
                            ...
                            <div class="form-section">
                                <div class="form-group">
                                    ...
                                    <input
                                        ...
                                        id="user1"
                                        v-model="form.user1"
                                        placeholder="Entrer le nom complet de l'expéditeur"
                                        required
                                    />
                            ...
                            <div class="form-section">
                                <div class="form-group">
                                    ...
                                    <input
                                        ...
                                        id="user2"
                                        v-model="form.user2"
                                        placeholder="Entrer le nom complet du destinataire"
                                        required
                                    />
                            ...
                            <div class="form-section">
                                <div class="form-group">
                                    <label for="tarif" class="form-label required">Prix d'Expédition</label>
                                    <div class="input-with-unit">
                                        <input
                                            type="number"
                                            class="form-input"
