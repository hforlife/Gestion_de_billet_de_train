...
const form = useForm({
    voyage_id: props.tarif.voyage_id || "",
    classe_wagon_id: props.tarif.classe_wagon_id || "",
    prix: props.tarif.prix || "",
    date_effet: props.tarif.date_effet || "",
    date_expiration: props.tarif.date_expiration || "",
});

const { errors } = form;

const submit = () => {
    form.put(route("tarif.update", props.tarif.id), {
        onSuccess: () => {
            Swal.fire("Succès", "Tarif modifié avec succès.", "success");
        },
        onError: (errors) => {
        ...
        <div class="form-header">
            <div class="header-content">
                <div class="header-title-wrapper">
                    <h1 class="page-title">Modification Tarif</h1>
                </div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <select
                                ...
                                class="form-select"
                                :class="{
                                    'is-invalid': errors.classe_wagon_id,
                                }"
                            >
                                <option value="" disabled>
                            ...
                            <p v-if="errors.classe_wagon_id" class="form-error">
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <input
                                ...
                                :min="form.date_effet"
                            />
                            <p v-if="errors.date_expiration" class="form-error">
