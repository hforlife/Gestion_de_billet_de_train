        ...
        <div class="sales-header">
            <div class="header-content">
                <div class="header-title-wrapper">
                    ...
                    <Link :href="route('tarif.create')" class="btn-create">
        ...
        <div class="sales-container">
            ...
            <div class="sales-card">
                ...
                <div class="table-header">
                    <h3 class="table-title">Liste des Tarifs</h3>
                    <Link
                ...
                <div class="table-responsive">
                    <table class="sales-table">
                        ...
                        <tbody>
                            <tr
                                v-for="(tarif, index) in tarifs.data"
                                :key="tarif.id"
                            >
                                <td class="py-1">
                                    {{ index + 1 }}
                ...
                <div class="table-footer">
                    <div class="pagination-info">
                        <p class="text-muted">
                            Affichage de {{ tarifs.from }} à {{ tarifs.to }} sur
                            {{ tarifs.total }} tarifs
                        </p>
                    </div>
