...
class DashboardController extends Controller
{
    ...
    {
        // Total des entités
        $ticketsCount = Ventes::count();
        $revenusTotaux = Ventes::sum('prix');
        $trainsCount = Trains::count();
        $voyagesCount = Voyages::count();
        $garesCount = Gares::count();
        ...
        $revenusMensuels = Ventes::selectRaw("
        ...
        $ventesParMois = Ventes::selectRaw("
                TO_CHAR(created_at, 'YYYY-MM') as mois, 
